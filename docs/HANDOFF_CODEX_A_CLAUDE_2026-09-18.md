...
| Etapas y resultado comercial | Unificados durante QA operativo | Cuentas activas, ficha, clasificación y registro manual ahora usan las 12 etapas canónicas; los 9 valores anteriores se mapean de forma compatible; Ganado/Perdido/Pausado pasan a Resultado separado | verificar visualmente después del despliegue con una ficha real, sin cambiarla |
...
- El futuro **Catálogo y cotizador comercial unificado** dejó de ser una mención suelta: `docs/COTIZADOR_COMERCIAL_SPEC.md` define una única herramienta para todos los productos y variantes del Catálogo Maestro, navegable por familia y subfamilia, con precios, fichas técnicas, carrito, historial y PDF. No habrá cotizadores separados ni un MVP exclusivo de Resinplast. Las familias con precios verificados podrán habilitarse gradualmente sobre una arquitectura común. Grupo Poliplast aparece siempre; Penosil, Resinplast y PURMAC suman su identidad visual, y los documentos mixtos conservan a Grupo Poliplast como marca principal.
- Decisión posterior de arquitectura: el cotizador comienza como **aplicación compañera separada del CRM**, con despliegue propio pero datos gobernados compartidos e integración futura prevista. La decisión y sus consecuencias están en `docs/ADR-001-COTIZADOR_APLICACION_SEPARADA.md`. El inventario técnico se persiste en Supabase con RLS por organización/rol, no duplicado por canal de WhatsApp.
