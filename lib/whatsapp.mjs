...
// Comparación de igual criterio que verifyMetaSignature: constante en tiempo
// para no filtrar por timing cuánto del verify_token coincidió. Buffers de
// largo distinto nunca llegan a timingSafeEqual (que lanza en ese caso) - se
// rechazan directo, sin comparar el contenido.
export function verifyMetaVerifyToken(received = '', expected = '') {
