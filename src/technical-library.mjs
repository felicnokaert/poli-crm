...
export const TECHNICAL_LIBRARY = [
  ...
  { id: 'resinplast-resina-epoxi', family: 'Resinplast', subfamily: 'Resina epoxi', product: 'Resina epoxi', docType: 'ficha_tecnica', sourceFile: 'PRODUCTOS/RESINAS/Ficha Técnica RESINA EPOXI/resina_epoxi-FT.pdf', version: null, verified: false },
