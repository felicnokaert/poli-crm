...
-- Origen: docs/MIGRACION_BASE_TECNICA.sql (commit 9260f6b, 2026-09-10
-- 17:46:49 -0300, "feat: persist technical document catalog in Supabase
-- (base tecnica)"). Corresponde a la migración registrada en el proyecto
-- remoto como "base_tecnica_technical_documents" (versión 20260910204355);
-- el endurecimiento de permisos que el mismo archivo doc incluía al final
-- se registró aparte como "base_tecnica_harden_function_execute"
-- (20260910204437) y se reconstruye en el siguiente archivo.
--
...
-- Sin política de DELETE a propósito (en esta migración): "ningún documento
-- se borra o mueve durante la auditoría" (Sección 5 de la spec). Ver
-- 20260911141754_add_technical_documents_delete_policy.sql - esta regla se
-- relajó más adelante para permitir borrado por el rol admin.
